...
$config['mongo_db']['active'] = 'local';

$config['mongo_db']['default']['no_auth'] = TRUE;
$config['mongo_db']['default']['hostname'] = '192.168.0.55';
...
$config['mongo_db']['local']['hostname'] = '192.168.0.11';
$config['mongo_db']['local']['port'] = '27017';
$config['mongo_db']['local']['username'] = 'username';
$config['mongo_db']['local']['password'] = 'password';
$config['mongo_db']['local']['database'] = 'pocketpasport';
